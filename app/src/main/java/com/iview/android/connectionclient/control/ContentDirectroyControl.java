...
public class ContentDirectroyControl {
    private static final String TAG = "ContentDirectroyControl";

    private final ControlPoint controlPoint;

    public ContentDirectroyControl(ControlPoint controlPoint) {
    ...
    {
        Device foundDev = controlPoint.getDevice(name);
    ...
    public void printContentNode(ContentNode node, int indentLevel)
    {
        ...
        if (node.isContainerNode()) {
            ...
            System.out.print("node :" + node.getTitle()+ " is Container. NContentNodes num is:" + nContentNodes + ", stringid:" + node.getID() + "\r\n");
            for (n=0; n<nContentNodes; n++) {
                ContentNode cnode = containerNode.getContentNode(n);
                System.out.print("print Content Node :" + cnode.getTitle() + ",isItem:"+ node.isItemNode() + "\r\n");
    ...
    {
        DeviceList devList = controlPoint.getDeviceList();
